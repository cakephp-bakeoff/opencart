 ...
 * Coupons Model
 *
 * @property \CakePHPOpencart\Model\Table\Opencart2\CategoryTable&\Cake\ORM\Association\BelongsToMany $Category
 ...
 */
class CouponsTable extends \CakePHPOpencart\Model\Table\OpencartAbstract\AbstractCouponsTable
{
    /**
     * Initialize method
     *
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->scalar('uses_customer')
            ->maxLength('uses_customer', 11)
